...
return (new CustomEvent(event_name,(function (){var obj27005 = ({"detail":data});
return obj27005;
})()));
} else {
...
var f = (function (){var pred__27012 = cljs.core._EQ_;
var expr__27013 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27012.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27013))){
return (function (p1__27006_SHARP_){
return console.warn(p1__27006_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27012.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27013))){
return (function (p1__27007_SHARP_){
return console.debug(p1__27007_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27012.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27013))){
return (function (p1__27008_SHARP_){
return console.error(p1__27008_SHARP_);
});
} else {
return (function (p1__27009_SHARP_){
return console.log(p1__27009_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27016){
...
var eval_fn = cljs.core.get.call(null,map__27017__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27019_SHARP_){
return new_def.callback(p1__27019_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27020){
var vec__27021 = p__27020;
var ky = cljs.core.nth.call(null,vec__27021,(0),null);
...
}catch (e27026){if((e27026 instanceof Error)){
var e = e27026;
return not_found;
} else {
throw e27026;
...
//# sourceMappingURL=utils.js.map?rel=1580245071714
