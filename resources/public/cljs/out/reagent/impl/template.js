...
var G__34312 = o;
goog.object.set(G__34312,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__34316 = o;
goog.object.set(G__34316,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__34317__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__34318__i < G__34318__a.length) {G__34318__a[G__34318__i] = arguments[G__34318__i + 0]; ++G__34318__i;}
  args = new cljs.core.IndexedSeq(G__34318__a,0,null);
} 
return G__34317__delegate.call(this,args);};
...
return G__34317__delegate(args);
});
...
var G__34320 = props;
var G__34320__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__34320,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34320);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__34320__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__34320__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__34321 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__34321,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__34321;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__34322){
...
var on_write = cljs.core.get.call(null,map__34323__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__34325_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__34325_SHARP_);
}));
} else {
return null;
}
...
var vec__34328 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__34328,(0),null);
var id = cljs.core.nth.call(null,vec__34328,(1),null);
var className = cljs.core.nth.call(null,vec__34328,(2),null);
...
var temp__5739__auto___34332 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___34332 == null)){
} else {
var key_34333 = temp__5739__auto___34332;
(jsprops.key = key_34333);
}
...
var temp__5739__auto___34334 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___34334 == null)){
} else {
var key_34335 = temp__5739__auto___34334;
(jsprops.key = key_34335);
}
...
var temp__5739__auto___34336 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___34336 == null)){
} else {
var key_34337 = temp__5739__auto___34336;
(jsprops.key = key_34337);
}
...
var G__34339 = n;
if(cljs.core._EQ_.call(null,"",G__34339)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__34339)){
return x;
} else {
...
var len__4789__auto___34342 = arguments.length;
var i__4790__auto___34343 = (0);
while(true){
if((i__4790__auto___34343 < len__4789__auto___34342)){
args__4795__auto__.push((arguments[i__4790__auto___34343]));

var G__34344 = (i__4790__auto___34343 + (1));
i__4790__auto___34343 = G__34344;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq34340){
var G__34341 = cljs.core.first.call(null,seq34340);
var seq34340__$1 = cljs.core.next.call(null,seq34340);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34341,seq34340__$1);
}));
...
break;
default:
var G__34347 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__34347;
continue;
...
var ctx = ({});
var vec__34349 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__34349,(0),null);
var derefed = cljs.core.nth.call(null,vec__34349,(1),null);
...
var G__34352 = (cljs.core.count.call(null,argv) - first_child);
switch (G__34352) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1580245309901
